        ...
        <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-32">
          <div className="space-y-12">
            ...
            <p className="text-xl ">
              ...
              animi ducimus placeat unde dicta similique magnam expedita
              necessitatibus aliquid accusamus quaerat, minima itaque. Soluta
              nemo porro corrupti nulla molestias facere.
            </p>

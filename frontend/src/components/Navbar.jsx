...
export const Navbar = () => {
  ...
  const [sticky, setSticky] = useState(false); // useState import is needed here
  ...
  }, []); // Only need this effect to run once
  ...
  return (
    <div
      className={`max-w-screen-xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
        sticky
